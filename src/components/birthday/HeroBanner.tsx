    ...
    return (
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8 items-center sm:items-start relative z-10 py-20">
                ...
                <div>
                    <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold leading-normal lg:leading-30 bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-500 bg-clip-text text-transparent break-words">
                ...
                >
                    <div className="relative max-w-full sm:max-w-md mx-auto lg:mx-0">
                        <div className="absolute -inset-4 bg-gradient-to-r from-orange-400 via-purple-400 to-yellow-400 rounded-3xl blur-sm opacity-75"></div>
